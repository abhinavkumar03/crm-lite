...
SCHEMAS = {
    ...
    "DashboardResponse": {
        ...
        "properties": {
            ...
            "emails_sent_today": {"type": "integer", "format": "int64"},
            "whatsapp_sent_today": {"type": "integer", "format": "int64"},
            "failed_notifications": {"type": "integer", "format": "int64"},
            "scheduled_notifications": {"type": "integer", "format": "int64"},
            "active_workflows": {"type": "integer", "format": "int64"},
            "disabled_workflows": {"type": "integer", "format": "int64"},
            "workflows_executed_today": {"type": "integer", "format": "int64"},
            "workflows_failed_today": {"type": "integer", "format": "int64"},
            "avg_workflow_duration_ms": {"type": "number"},
        },
    },
    "SearchHit": {
        "type": "object",
    ...
    "OrgSummary": {
        ...
        "properties": {
            "id": _UUID,
            "name": {"type": "string", "example": "CRM Lite Demo"},
            "slug": {"type": "string", "example": "crm-lite-demo"},
            "logo_url": {"type": "string", "nullable": True},
            "description": {"type": "string", "nullable": True},
            "role_slug": {"type": "string", "example": "owner"},
            "is_active": {"type": "boolean"},
        },
    },
    "OrgSummaryList": {
