...
def build_paths():
    ...
    paths["/leads"] = {
        "get": op(
            ...
            "Leads",
            op_id="listLeads",
            params=page_limit + [q("status", example="new")],
            responses={
                **ok("#/components/schemas/ListLeadResponse"),
                **err_refs("Unauthorized"),
            },
        ),
        "post": op(
            ...
            op_id="createLead",
            req=json_body(
                "#/components/schemas/CreateLeadRequest",
                {
                    "name": "Acme Corp",
            ...
            responses={
                **ok("#/components/schemas/LeadResponse", code="201"),
                **err_refs("Unauthorized", "BadRequest", "ValidationError"),
            },
        ),
    }
    paths["/leads/{id}"] = {
        "get": op(
            ...
            responses={
                **ok("#/components/schemas/LeadResponse"),
        ...
        "put": op(
            ...
            op_id="updateLead",
            params=[path_param("id")],
            req=json_body("#/components/schemas/UpdateLeadRequest"),
            responses={
                **ok("#/components/schemas/LeadResponse"),
    ...
    paths["/contacts"] = {
        "get": op(
            ...
            params=page_limit,
            responses={
                **ok("#/components/schemas/ListContactResponse"),
                **err_refs("Unauthorized"),
            },
        ),
        "post": op(
            ...
            "Contacts",
            op_id="createContact",
            req=json_body("#/components/schemas/CreateContactRequest"),
            responses={
                **ok("#/components/schemas/ContactResponse", code="201"),
                **err_refs("Unauthorized", "BadRequest", "ValidationError"),
            },
        ),
    }
    paths["/contacts/{id}"] = {
        "get": op(
            ...
            params=[path_param("id")],
            responses={
                **ok("#/components/schemas/ContactResponse"),
                **err_refs("Unauthorized", "NotFound"),
            },
        ),
        "put": op(
            ...
            op_id="updateContact",
            params=[path_param("id")],
            req=json_body("#/components/schemas/UpdateContactRequest"),
            responses={
                **ok("#/components/schemas/ContactResponse"),
                **err_refs("Unauthorized", "NotFound", "BadRequest"),
            },
    ...
    paths["/tasks"] = {
        "get": op(
            ...
            "Tasks",
            op_id="listTasks",
            params=page_limit + [q("status")],
            responses={
                **ok("#/components/schemas/ListTaskResponse"),
                **err_refs("Unauthorized"),
            },
        ),
        "post": op(
            ...
            "Tasks",
            op_id="createTask",
            req=json_body("#/components/schemas/CreateTaskRequest"),
            responses={
                **ok("#/components/schemas/TaskResponse", code="201"),
    ...
    paths["/tasks/{id}"] = {
        "get": op(
            ...
            params=[path_param("id")],
            responses={
                **ok("#/components/schemas/TaskResponse"),
                **err_refs("Unauthorized", "NotFound"),
            },
        ),
        "put": op(
            ...
            op_id="updateTask",
            params=[path_param("id")],
            req=json_body("#/components/schemas/UpdateTaskRequest"),
            responses={
                **ok("#/components/schemas/TaskResponse"),
                **err_refs("Unauthorized", "NotFound", "BadRequest"),
            },
    ...
    for entity in ("lead", "task", "contact"):
        pid = f"{entity}Id"
        title = entity.title()
        paths[f"/notes/{entity}/{{{pid}}}"] = {
            "get": op(
                f"List {entity} notes",
                "Notes",
                op_id=f"list{title}Notes",
                params=[path_param(pid)],
                responses={
                    **ok("#/components/schemas/NoteList"),
                    **err_refs("Unauthorized", "NotFound"),
                },
            ),
            "post": op(
                f"Create {entity} note",
                "Notes",
                op_id=f"create{title}Note",
                params=[path_param(pid)],
                req=json_body(
                    "#/components/schemas/CreateNoteBody",
                    {"note": "Followed up by phone"},
                ),
                responses={
                    **ok("#/components/schemas/NoteResponse", code="201"),
                    **err_refs("Unauthorized", "BadRequest"),
                },
            ),
        }
        paths[f"/calllogs/{entity}/{{{pid}}}"] = {
            "get": op(
                f"List {entity} call logs",
                "CallLogs",
                op_id=f"list{title}CallLogs",
                params=[path_param(pid)],
                responses={
                    **ok("#/components/schemas/CallLogList"),
                    **err_refs("Unauthorized", "NotFound"),
                },
            ),
            "post": op(
                f"Create {entity} call log",
                "CallLogs",
                op_id=f"create{title}CallLog",
                params=[path_param(pid)],
                req=json_body("#/components/schemas/CreateCallLogRequest"),
                responses={
                    **ok("#/components/schemas/CallLogResponse", code="201"),
                    **err_refs("Unauthorized", "BadRequest"),
                },
            ),
        }
        paths[f"/attachments/{entity}/{{{pid}}}"] = {
            "get": op(
                f"List {entity} attachments",
                "Attachments",
                op_id=f"list{title}Attachments",
                params=[path_param(pid)],
                responses={
                    **ok("#/components/schemas/AttachmentList"),
                    **err_refs("Unauthorized", "NotFound"),
                },
            ),
            "post": op(
                f"Create {entity} attachment metadata",
                "Attachments",
                op_id=f"create{title}Attachment",
                params=[path_param(pid)],
                req=json_body("#/components/schemas/CreateAttachmentRequest"),
                responses={
                    **ok("#/components/schemas/AttachmentResponse", code="201"),
                    **err_refs("Unauthorized", "BadRequest"),
                },
            ),
        }
        paths[f"/activities/{entity}/{{{pid}}}"] = {
            "get": op(
                f"List {entity} activities",
                "Activities",
                op_id=f"list{title}Activities",
                params=[path_param(pid)],
                responses={
                    **ok("#/components/schemas/ActivityList"),
                    **err_refs("Unauthorized", "NotFound"),
                },
            ),
        }
    ...
    paths["/notes/{noteId}"] = {
        "put": op(
            ...
            "Notes",
            op_id="updateNote",
            params=[path_param("noteId")],
            req=json_body("#/components/schemas/UpdateNoteRequest"),
            responses={
                **ok("#/components/schemas/NoteResponse"),
                **err_refs("Unauthorized", "NotFound"),
            },
        ),
        "delete": op(
    ...
    paths["/calllogs/{noteId}"] = {
        "put": op(
            "Update call log",
            "CallLogs",
            op_id="updateCallLog",
            params=[path_param("noteId")],
            req=json_body("#/components/schemas/UpdateCallLogRequest"),
            responses={
                **ok("#/components/schemas/CallLogResponse"),
                **err_refs("Unauthorized", "NotFound"),
            },
        ),
        "delete": op(
