...
// (records, imports, exports, export-templates, views, fields, validation) on one
// router, verifying the combined route tree builds without a Gin panic — the
// "export" / "exports" / "export-templates" static siblings must coexist with the
// other engines' parameterized routes.
